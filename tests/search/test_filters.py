...
class SearchFilterTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.events = [
            ...
            NormalizedEvent(
                ...
                severity="low",
                target="device-2",
                raw={"message": "successful sign in"},
            ),
        ]
    ...
    def test_parses_relative_and_absolute_time_expressions(self) -> None:
        ...
        self.assertEqual(
            parse_time_expression("2025-01-01T10:00:00Z", now=self.now), datetime(2025, 1, 1, 10, 0, tzinfo=UTC)
        )
