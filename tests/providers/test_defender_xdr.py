...
def test_defender_xdr_fetches_incidents_alerts_and_timeline(state_dir) -> None:
                    ...
                    "value": [
                        {
                            "id": "incident-id",
                            "incidentId": 1001,
                            "displayName": "Malware incident",
                            "severity": "high",
                            "status": "resolved",
                            "lastUpdateDateTime": "2025-01-01T00:05:00Z",
                        }
                    ]
                },
            )
                    ...
                    "value": [
                        {
                            ...
                            "severity": "medium",
                            "status": "inProgress",
                            "createdDateTime": "2025-01-01T00:06:00Z",
                        }
                    ]
                },
            )
            ...
            return httpx.Response(
                ...
                json={
                    "value": [
                        {
                            "id": "timeline-1",
                            "eventTime": "2025-01-01T00:07:00Z",
                            "eventType": "ProcessCreated",
                            "initiatingProcessAccountName": "endpoint-user",
    ...
    async def scenario() -> None:
        provider = DefenderXdrProvider(
            tenant_id="tenant-id",
            client_id="client-id",
            client_secret="client-secret",
            checkpoint_store=CheckpointStore(state_dir / "checkpoints"),
            raw_log_cache=RawLogCache(state_dir / "cache"),
